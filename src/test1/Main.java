...
public class Main extends JFrame implements Runnable {
	...
	Image background = new ImageIcon(Main.class.getResource("background.png")).getImage(); // 배경.
	int frameWidth = 800; // 프레임 폭
	int frameHeight = 900; // 프레임 높이
	Player player;
	Unit unit;
	Thread th;
	Image buffImg;
